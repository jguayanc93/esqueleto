...
async function actualisar_nuevos_productos(req,res,next) {
    try{
...
async function api_subir_nuevos_productos(listado){
    try {
        const api_impacto= "https://backimpacto.impacto.com.pe/ecommerce/products-test/update_external_products_dolares/";
        // const api_impacto= "https://backimpacto.impacto.com.pe/ecommerce/products-test/update_external_products/";
...
let query_prd_lista = (resolve,reject,conexion)=>{
    ...
    let sp_sql="select top 3 Usr_001 as 'part_code',codi as 'code_external', descr as 'name_store' , isnull(cast((a.pvus-(a.pvus*b.dscto_maxven/100)) as decimal(10,4)),0) as 'price_sale', stoc as 'stock','4' as 'store' from prd0101 a  left join Dtl_Dscto_Marca_Tc b on  a.codmar=b.codmar and b.codtcl='F' where a.estado ='1' and left(a.codi,2) in ('10','01','09','02','11','12','06','04','05') and (stoc-svta-pedi)>3 and pvus>0";
...
module.exports={actualisar_nuevos_productos}