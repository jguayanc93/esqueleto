...
let bprd_sugerencia = (req,res,next) => {

    console.log(req.query)
    let sugerencia=req.query.dscr;
...
let bd_c_query = (res,sugerencia)=>{
    ...
    let sp_sql="select codi,descr,marc,(CAST(stoc as int)-(CAST(svta as int)+CAST(pedi as int)))as'stoc',Usr_001,codmar,Usr_016 from prd0101 where estado=1 AND descr like @pista";
...
module.exports={bprd_sugerencia}